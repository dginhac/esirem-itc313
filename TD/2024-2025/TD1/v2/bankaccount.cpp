...
// Constructor
BankAccount::BankAccount(std::string account_number, const Client client, double initial_balance)
    : _account_number(account_number), _client(client), _balance(initial_balance) {
...
std::string BankAccount::accountInfo() const {
    return "Account No: " + _account_number + ", Client: " + _client.toString() + ", Balance: " + std::to_string(_balance) + " euros.";
}
